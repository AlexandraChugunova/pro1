def get_absolute_url(url, *args, **kwargs):
    ...
    :param url: домен
    :param args: произвольное количнство позиционных параметров
    :param kwargs: произвольное количнство именованных параметров"""


# добавляем к домену "/позиционный агрумент" и '?' после всех позиционных аргументов
    for i in args:
        url +='/'+i
    url += '?'
